      ...
      <div className="tela-inteira">
        <main>
          <nav className="menu-vertical">
            <ul> 
                <MenuListItem propsBotoesMenuVertical={"Início"}/>
                <MenuListItem propsBotoesMenuVertical={"Em alta"}/>
                <MenuListItem propsBotoesMenuVertical={"Inscrições"}/>
                <hr/>
                <MenuListItem propsBotoesMenuVertical={"Originais"}/>
                <MenuListItem propsBotoesMenuVertical={"Histórico"}/>
