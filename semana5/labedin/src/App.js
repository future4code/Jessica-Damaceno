...
import ProfilePicture from '../src/img/JJfoto.jpg';
  ...
  return (
    <div className="App">
      <div className="page-section-container">
        ...
        <CardPequeno 
          email="JJ7ECNO@gmail.com"
          end="O lugar de sempre nem sempre é o mesmo lugar =)" //"O lugar de sempre não é sempre o mesmo :-)"
        />
